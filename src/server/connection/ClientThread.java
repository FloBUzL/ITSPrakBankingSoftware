...
/**
 * thread that's created for every client connection
...
public class ClientThread extends Thread {
     ...
     * @param connection the connection object, which holds the socket to the client
     * @param data the database object
     * @param authErrors the auth errors object
     */
